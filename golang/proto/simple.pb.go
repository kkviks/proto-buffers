...
type Simple struct {
	...
	SampleLists []uint32 `protobuf:"varint,4,rep,packed,name=sample_lists,json=sampleLists,proto3" json:"sample_lists,omitempty"`
}
...
func (x *Simple) GetSampleLists() []uint32 {
	if x != nil {
...
var file_simple_proto_rawDesc = []byte{
	...
	0x70, 0x6c, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0d, 0x52,
